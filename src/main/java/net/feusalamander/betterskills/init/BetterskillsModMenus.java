...
public class BetterskillsModMenus {
	...
	public static final RegistryObject<MenuType<MiningTreeMenu>> MINING_TREE = REGISTRY.register("mining_tree", () -> IForgeMenuType.create(MiningTreeMenu::new));
	public static final RegistryObject<MenuType<CombatTreeMenu>> COMBAT_TREE = REGISTRY.register("combat_tree", () -> IForgeMenuType.create(CombatTreeMenu::new));
	public static final RegistryObject<MenuType<FarmingTreeMenu>> FARMING_TREE = REGISTRY.register("farming_tree", () -> IForgeMenuType.create(FarmingTreeMenu::new));
	public static final RegistryObject<MenuType<FishingTreeMenu>> FISHING_TREE = REGISTRY.register("fishing_tree", () -> IForgeMenuType.create(FishingTreeMenu::new));
	public static final RegistryObject<MenuType<ForagingTreeMenu>> FORAGING_TREE = REGISTRY.register("foraging_tree", () -> IForgeMenuType.create(ForagingTreeMenu::new));
}
