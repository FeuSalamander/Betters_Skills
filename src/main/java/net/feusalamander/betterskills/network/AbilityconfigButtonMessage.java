...
public class AbilityconfigButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BetterskillsMod.addNetworkMessage(AbilityconfigButtonMessage.class, AbilityconfigButtonMessage::buffer, AbilityconfigButtonMessage::new,
				AbilityconfigButtonMessage::handler);
	}
}
